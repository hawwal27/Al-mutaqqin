  ...
  return (
    <section className="bg-gradient-to-r from-green-50 to-white py-20 px-4 sm:px-6 lg:px-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        {/* Right: Images (shown second on mobile) */}
        <div className="w-full lg:w-1/2 flex flex-col items-center gap-6">
          ...
          <div className="relative flex flex-col items-center">
            ...
            />
            <img
              src="https://img.freepik.com/premium-photo/school-building-is-green-friends-with-green-grass_934343-747.jpg"
              alt="Top Image 1"
              className="w-72 h-48 object-cover rounded-xl shadow-md absolute hidden lg:block bottom-full left-[80px]"
            />
          </div>
